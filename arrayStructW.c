//Implement database management using array of structures (WITH POINTERS TO ARRAYS)
...
void display(struct component *, int *);
void append(struct component *, int *, int append_val);
void search(struct component *, int *);
void sort(struct component *, int *);
void modify(struct component *, int *);
...
void display(struct component *cmp, int *count)
{
...
void append(struct component *cmp, int *count, int append_val)
{
	int i;
...
void search(struct component *cmp, int *count)
{
...
void sort(struct component *cmp, int *count)
{
...
void modify(struct component *cmp, int *count)
{
	int selection, reSelection;
